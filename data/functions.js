function init_graph()
{
  ...
  d3.select("#cat_1")
      .on("click", function(d,i) {
          ...
          graph("1", y, x, diam, container, width, height)
          console.log("button1")
      })
  ...
  d3.select("#cat_2")
      .on("click", function(d,i) {
          ...
          container.selectAll(".y_axis").remove()
          console.log("button2")
          graph("2", y, x, diam, container, width, height)
      })
}

var thedata
function graph(filter, y, x, diam, container, width, height) {
